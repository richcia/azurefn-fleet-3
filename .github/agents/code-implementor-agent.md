...
- Create CI and CD workflows as disabled by default
- Create separate CD workflows for infrastructure and application code
- CD workflows should take environment variables
...
- Create a separate workflow file to setup the Azure federated identity for the managed identity used in the CD workflows called `setup-azure-federated-identity.yml`.
