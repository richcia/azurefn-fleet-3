...
5. Propose how code-implementor-agent's prompt could be improved based on the code review findings and save the proposed improvements in a file called `prompt_improvements_{ISSUE_NUMBER}_{PR_NUMBER}.json`.
...
- Update agent-activity-[ISSUE_NUMBER].log with every step an agent performs organized by step
