...
2. Focus on correctness, clarity, and consistency:
...
4. For Markdown spec/design docs:
   - Also follow the Markdown-spec review rubric in:
     `.github/instructions/specs-markdown.instructions.md`